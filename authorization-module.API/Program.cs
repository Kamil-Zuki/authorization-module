using authorization_module.API;
...
var dataSourceBuilder = new Npgsql.NpgsqlDataSourceBuilder(dbConnection);
...
// EF Core: актуализировать схему перед обработкой запросов (docker-compose: после healthy postgres).
